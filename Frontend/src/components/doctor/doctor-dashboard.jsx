...
import LiverDiseasePrediction from "./liver-disease-prediction";
import HeartDiseasePrediction from "./heart-disease-prediction";
import KidneyDiseasePrediction from "./kidney-disease-prediction";
